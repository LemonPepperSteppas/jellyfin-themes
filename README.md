...
| Theme | Status |
|---|---|
| [Cinematic Glass](themes/cinematic-glass/) | released, `cinematic-glass-v0.0.3` |

Themes are released under per-theme tags (`cinematic-glass-v0.0.3`) and served by jsDelivr
